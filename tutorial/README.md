...
3. We can know the delay between calling `write()` and sending a sample in an asynchronous write by enabling the timestamps. For instance: `python rtilogparser.py -i tutorial/logs/log1.txt --show-timestamp`
    ```
